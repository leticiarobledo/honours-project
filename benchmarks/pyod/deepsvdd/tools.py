...
from feature_extractor import parse_instances
...
def load_mnist(path, training_label, download=False, benchmarking=False):
    ...
    x_train = parse_instances(x_train, "mnist")
    x_test = parse_instances(x_test, "mnist")
...
def load_svhn(path, training_label=1, download=False, benchmarking=False):
    ...
    x_train = parse_instances(x_train, "svhn")
    x_test = parse_instances(x_test, "svhn")
...
def load_usps(path, training_label=1, download=False, benchmarking=False):
    ...
    x_train = parse_instances(x_train, "usps")
    x_test = parse_instances(x_test, "usps")
